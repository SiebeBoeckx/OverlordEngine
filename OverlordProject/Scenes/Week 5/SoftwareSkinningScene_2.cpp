...
void SoftwareSkinningScene_2::Update()
{
	...
	for (int i{}; i < m_SkinnedVertices.size(); ++i)
	{
		...
		if(i < 24)
		{
			result = XMVector3TransformCoord(vertexVector, bone0TransformMatrix);
		}
		else
		{
			result = XMVector3TransformCoord(vertexVector, bone1TransformMatrix);
		}
