...
public:
	...
	void SetUpVector(const XMFLOAT3& up) { m_Up = up; }
	void SetRightVector(const XMFLOAT3& right) { m_Right = right; }
	void SetForwardVector(const XMFLOAT3& forward) { m_Forward = forward; }
